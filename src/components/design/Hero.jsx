...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 h-6 mx-2.5 bg-n-8 shadow-xl rounded-b-[1.25rem] lg:h-5 lg:mx-4" />
      <div className="relative z-1 h-6 mx-6 bg-n-6/50 shadow-xl rounded-b-[1.25rem] lg:h-5 lg:mx-20" />
    </>
  );
};
