...
export const BackgroundCircles = () => {
  return (
    <>
      ...
      <div className="absolute top-[26.8rem] left-12 w-8 h-8 bg-gradient-to-b from-[#DD734F] to-[#1A1A32] rounded-full"></div>
      <div className="absolute top-[16.8rem] left-25 w-5 h-5 bg-gradient-to-b from-[#88E5BE] to-[#1A1A32] rounded-full"></div>
    </>
  );
};
