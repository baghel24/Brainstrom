    ...
    <Section id="how-to-use">
     <div className='container'>
        ...
        <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-5 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-5 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2" />
        </div>
        <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-5 rounded-3xl overflow-hidden">
            ...
            <div className='p-4 bg-n-11 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                <div>
